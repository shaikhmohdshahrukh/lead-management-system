package com.leadManagementSystem1.controllers;
...
import com.leadManagementSystem1.services.LeadService;
...
public class LeadController {
	...
	public List<Lead> findAllLead() {
		return leadService.findAllLead();
	}

	@GetMapping("/users/{userId}/leads")
	public List<Lead> findAllLeadUserId(@PathVariable Long userId) {
		return leadService.findAllLeadUserId(userId);
	}
	...
	public ResponseEntity<?> createLeads(@RequestBody Lead lead) {
		Long id = leadService.createLead(lead);
